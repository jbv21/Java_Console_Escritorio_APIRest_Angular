...
public class EscuelaConduccionBDImpl implements EscuelaConduccionBD {
    ...
    private List<EscuelaConduccion> getMapping(ResultSet rs) throws SQLException, PersistenciaException {
        ...
        while (rs.next()) {
            ...
            if(obj.getIdDepartamento() != null && !obj.getIdDepartamento().isEmpty() ){
                Departamento dep = new Departamento();
                dep.setId(obj.getIdDepartamento());
                dep.setNombre(departamentoBD.seleccionar(dep).getNombre());
                obj.setDepartamento(dep);
                
                if(obj.getDepartamento() != null && obj.getIdProvincia() != null && !obj.getIdProvincia().isEmpty() ){
                    Provincia pro = new Provincia();
                    pro.setId(obj.getIdProvincia());
                    pro.setDepartamento(dep);
                    pro.setNombre(provinciaBD.seleccionar(pro).getNombre());
                    obj.setProvincia(pro);
                    if(obj.getProvincia() != null && obj.getIdDistrito()!= null && !obj.getIdDistrito().isEmpty() ){
                        Distrito dis = new Distrito();
                        dis.setId(obj.getIdDistrito());
                        dis.setProvincia(pro);
                        dis.setNombre(distritoBD.seleccionar(dis).getNombre());
                        obj.setDistrito(dis);
                    }
                }
